...
import com.finnest.app.helpers.HTML;
import com.finnest.app.helpers.Token;
import com.finnest.app.mailMessenger.MailMessenger;
...
public class RegisterController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody User user, BindingResult bindingResult, @RequestParam("confirm_password") String confirmPassword) {
        ...
        try {
            MailMessenger.htmlEmailMessenger("noreply@finnest.app", email, "Verify Account", emailBody);
        ...
        response.put("user", user); // or add other data as needed
