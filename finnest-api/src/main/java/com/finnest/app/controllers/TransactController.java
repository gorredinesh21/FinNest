...
import com.finnest.app.models.PaymentRequest;
import com.finnest.app.models.TransferRequest;
import com.finnest.app.models.User;
import com.finnest.app.repository.AccountRepository;
import com.finnest.app.repository.PaymentRepository;
import com.finnest.app.repository.TransactRepository;
...
public class TransactController {
    ...
    public ResponseEntity deposit(@RequestBody Map<String, String> requestMap, HttpSession session) {
        ...
        response.put("accounts", accountRepository.getUserAccountsById(user_id)); // add the token into the JSON response
