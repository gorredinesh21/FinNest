package com.finnest.app.helpers.authorization;
...
public class JwtService {
    // Signing key for tokens. HMAC-SHA256 is used here.
    // NOTE: In production this should be loaded from an environment variable
    // or a secrets manager rather than being hardcoded.
    @Value("${finnest.app.secret:fNn3st_S3cr3t_K3y_Change_Me_In_Production_2026_xY7}")
