...
function AccountForm({
  ...
  const [accountInfo, setAccountInfo] = useState({
    transactionType: "", // Transaction Type select box
    
  });
  const [paymentInfo, setPaymentInfo] = useState({
    beneficiary: "", // Transaction Type select box
    account_number: "", // Transaction Type select box
    reference: "", // Transaction Type select box
    payment_amount: "", // Transaction Type select box
    ...
    try {
      const response = await axios.post(apiUrl, jsonData, {
        headers: {
          ...
          Authorization: "Bearer: " + accessToken, // content type setting for sending JSON
        },
      });
    ...
    >
      ...
      >
        ...
        {accountInfo.transactionType === "Deposit Transaction" ? (
          // shown when "Deposit Transaction" is selected
          <>
            <TextField
              readonly
              disabled
